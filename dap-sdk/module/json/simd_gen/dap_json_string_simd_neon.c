...
/**
 * @file dap_json_string_simd_neon.c
 * @brief SIMD JSON String Scanner - NEON Implementation
 * 
 ...
 * 
 * Performance: ~16 chars per cycle (vs 1 char/cycle reference)
 * Expected impact: +16x for string scanning
 * 
...
#include "dap_json_string_simd_neon.h"

#define LOG_TAG "dap_json_string_neon"

/**
 * @brief NEON-optimized JSON string scanner
 * @details Processes 16 bytes at once using SIMD instructions
 * 
...
#include "arch/string_scanner_vector_impl.c"

...
/**
 * @file dap_json_string_simd_sve.c
 * @brief SIMD JSON String Scanner - SVE Implementation
 * 
...
#include "dap_json_string_simd_sve.h"

#define LOG_TAG "dap_json_string_sve"

/**
 * @brief SVE-optimized JSON string scanner
...
#include "arch/arm/string_scanner_sve_impl.c"

...
int dap_json_stage1_run_avx512(dap_json_stage1_t *a_stage1)
{
    ...
    debug_if(dap_json_get_debug(), L_DEBUG, "Starting AVX-512 SimdJSON Stage 1 tokenization (%zu bytes)", input_len);
    ...
    debug_if(dap_json_get_debug(), L_DEBUG, "AVX-512 SimdJSON Stage 1 complete: %zu tokens (%zu structural, %zu strings, %zu numbers, %zu literals)",

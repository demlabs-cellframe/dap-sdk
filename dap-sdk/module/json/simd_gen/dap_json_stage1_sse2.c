...
int dap_json_stage1_run_sse2(dap_json_stage1_t *a_stage1)
{
    ...
    debug_if(dap_json_get_debug(), L_DEBUG, "Starting SSE2 SimdJSON Stage 1 tokenization (%zu bytes)", input_len);
    ...
    debug_if(dap_json_get_debug(), L_DEBUG, "SSE2 SimdJSON Stage 1 complete: %zu tokens (%zu structural, %zu strings, %zu numbers, %zu literals)",

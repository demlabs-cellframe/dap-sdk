...
/**
 * @file dap_mlkem_poly_ops_avx2.c
 * @brief AVX2 poly I/O operations for ML-KEM (compress, serialize, mulcache).
...
void dap_mlkem_poly_compress_d4_avx2(uint8_t *a_r, const int16_t *a_coeffs)
{
...
__attribute__((target("avx2")))
void dap_mlkem_poly_compress_d5_avx2(uint8_t *a_r, const int16_t *a_coeffs)
{
    const __m256i v = _mm256_set1_epi16(20159);
...
__attribute__((target("avx2")))
void dap_mlkem_poly_decompress_d4_avx2(int16_t *a_r, const uint8_t *a_a)
{
...
__attribute__((target("avx2")))
void dap_mlkem_poly_decompress_d5_avx2(int16_t *a_r, const uint8_t *a_a)
{
    const __m256i q = _mm256_set1_epi16(MLKEM_Q);
    const __m256i shufbidx = _mm256_set_epi8(
...
__attribute__((target("avx2")))
void dap_mlkem_poly_tobytes_avx2(uint8_t *a_r, const int16_t *a_coeffs)
{
...
__attribute__((target("avx2")))
void dap_mlkem_poly_frombytes_avx2(int16_t *a_r, const uint8_t *a_a)
{
    const __m256i v_shuf = _mm256_setr_epi8(
...
__attribute__((target("avx2")))
void dap_mlkem_poly_frommsg_avx2(int16_t *a_r, const uint8_t *a_msg)
{
...
__attribute__((target("avx2")))
void dap_mlkem_poly_tomsg_avx2(uint8_t *a_msg, const int16_t *a_coeffs)
{
...
__attribute__((target("avx2")))
void dap_mlkem_poly_mulcache_compute_avx2(int16_t * restrict a_cache,

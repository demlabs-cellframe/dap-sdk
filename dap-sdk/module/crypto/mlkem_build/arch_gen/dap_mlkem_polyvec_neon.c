...
/**
 * @file dap_mlkem_polyvec_neon.c
 * @brief NEON polyvec compress/decompress + basemul_acc_cached for ML-KEM.
...
void dap_mlkem_polyvec_compress_d11_neon(uint8_t *a_r, const int16_t *a_coeffs)
{
...
void dap_mlkem_polyvec_compress_d10_neon(uint8_t *a_r, const int16_t *a_coeffs)
{
    const int16x8_t l_v = vdupq_n_s16(20159);
    const int16x8_t l_v8 = vshlq_n_s16(l_v, 3);
...
void dap_mlkem_polyvec_decompress_d11_neon(int16_t *a_r, const uint8_t *a_a)
{
...
void dap_mlkem_polyvec_decompress_d10_neon(int16_t *a_r, const uint8_t *a_a)
{
...
void dap_mlkem_polyvec_basemul_acc_cached_neon(

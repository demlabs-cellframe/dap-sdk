...
/**
 * @file dap_mlkem_rej_uniform_avx2.c
 * @brief AVX2 rejection sampling for ML-KEM gen_matrix.
...
/* AVX2 rejection sampling for ML-KEM gen_matrix.
 * Processes 48 bytes → 32 candidates per iteration.
...
unsigned dap_mlkem_rej_uniform_avx2(int16_t *a_r, unsigned a_len,
                                               const uint8_t *a_buf, unsigned a_buflen)
{

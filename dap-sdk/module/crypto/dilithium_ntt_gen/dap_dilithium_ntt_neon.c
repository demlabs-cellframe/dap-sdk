...
/**
 * @file dap_dilithium_ntt_neon.c
 * @brief NEON specialized NTT32 for Dilithium/ML-DSA
...
void dap_dilithium_ntt_forward_neon(int32_t a_coeffs[DIL_N])
{
...
void dap_dilithium_ntt_inverse_neon(int32_t a_coeffs[DIL_N])
{
...
void dap_dilithium_pointwise_mont_neon(

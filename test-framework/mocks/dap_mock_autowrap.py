...
class MockAutoWrapper:
    ...
    def scan_mock_declarations(self) -> Set[str]:
        ...
        print(f"📋 Scanning {self.test_source} for mock declarations...")
    ...
    def scan_wrapper_definitions(self) -> Dict[str, dict]:
        ...
        for wrapper_type, func_name, params, args in matches:
            ...
            print(f"   ✅ {func_name}: {wrapper_type} wrapper found")
    ...
    def generate_cmake_integration(self) -> Path:
        ...
        print(f"\n📝 Generating CMake integration: {cmake_file}")
    ...
    def generate_wrapper_template(self) -> Path:
        ...
        print(f"\n⚠️  Missing wrappers for {len(missing_wrappers)} functions")
        print(f"📝 Generating template: {template_file}")
        ...
        print(f"✅ Template generated with {len(missing_wrappers)} function stubs")
        for func in sorted(missing_wrappers):
            print(f"   ⚠️  {func}")

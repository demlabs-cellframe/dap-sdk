...
function(dap_mock_autowrap TARGET_NAME)
    ...
    add_custom_command(
        OUTPUT ${WRAP_RESPONSE_FILE} ${CMAKE_FRAGMENT} ${MACROS_HEADER} ${CUSTOM_MOCKS_HEADER}
        COMMAND ${SCRIPT_EXECUTOR} ${GENERATOR_SCRIPT} ${MOCK_GEN_DIR} ${SOURCE_BASENAME} ${ALL_SOURCES}
        DEPENDS ${ALL_SOURCES}
    ...
    add_custom_target(${TARGET_NAME}_mock_gen
        DEPENDS ${WRAP_RESPONSE_FILE} ${CMAKE_FRAGMENT} ${CUSTOM_MOCKS_HEADER}
    )
    ...
    # Files are generated by dap_mock_autowrap.sh, so they should exist after generation
    # Use absolute paths to ensure they're found
    # Note: CUSTOM_MOCKS_HEADER includes MACROS_HEADER, so we only need to include CUSTOM_MOCKS_HEADER
    target_compile_options(${TARGET_NAME} PRIVATE "-include" "${CUSTOM_MOCKS_HEADER}")

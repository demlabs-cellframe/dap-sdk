...
/* Parameterized variants for FIPS 204 (use per-level gamma/d from param struct) */
...
void poly_uniform_gamma1m1_p(poly *a, const unsigned char *seed, uint16_t nonce, const dilithium_param_t *p);

...
const ecdsa_ge_t ECDSA_GENERATOR = {
    .x = {{ 0x2F81798UL, 0x0A056C5UL, 0x28D959FUL, 0x36CB738UL, 0x3029BFCUL,
            0x3A1C2C1UL, 0x206295CUL, 0x2EEB156UL, 0x27EF9DCUL, 0x01E6F99UL }},
    .y = {{ 0x310D4B8UL, 0x1F423FEUL, 0x14199C4UL, 0x1229A15UL, 0x0FD17B4UL,
            0x384422AUL, 0x24FBFC0UL, 0x3119576UL, 0x27726A3UL, 0x0120EB6UL }},
    .infinity = false
};
#endif

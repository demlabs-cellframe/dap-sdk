...
static const dap_ntt_params16_t g_kyber_ntt_params = {
    .n          = KYBER_N,
    .q          = KYBER_Q,
    .qinv       = QINV,
    .zetas      = zetas,
...
void ntt(int16_t r[256]) {
  dap_ntt16_forward(r, &g_kyber_ntt_params);
}

void invntt(int16_t r[256]) {
  dap_ntt16_inverse(r, &g_kyber_ntt_params);
}
...
void basemul(int16_t r[2],
             ...
             int16_t zeta)
{
  dap_ntt16_basemul(r, a, b, zeta, &g_kyber_ntt_params);
}

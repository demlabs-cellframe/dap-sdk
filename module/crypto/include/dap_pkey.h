...
enum dap_pkey_type_enum {
    ...
    DAP_PKEY_TYPE_SIG_BLISS = 0x0901,
    DAP_PKEY_TYPE_SIG_TESLA = 0x0902,
    DAP_PKEY_TYPE_SIG_DILITHIUM =  0x0903,
    DAP_PKEY_TYPE_SIG_PICNIC = 0x0904,
    DAP_PKEY_TYPE_SIG_FALCON = 0x0905,
    ...
    DAP_PKEY_TYPE_SIG_ML_DSA = 0x090a,
...
DAP_STATIC_INLINE const char *dap_pkey_type_to_str(dap_pkey_type_t a_type){
    switch (a_type.type) {
        ...
        case DAP_PKEY_TYPE_SIG_MULTI: return "DAP_PKEY_TYPE_SIG_MULTI";
        case DAP_PKEY_TYPE_SIG_BLISS: return "DAP_PKEY_TYPE_SIG_BLISS";
        case DAP_PKEY_TYPE_SIG_TESLA: return "DAP_PKEY_TYPE_SIG_TESLA";
        case DAP_PKEY_TYPE_SIG_PICNIC: return "DAP_PKEY_TYPE_SIG_PICNIC";
        case DAP_PKEY_TYPE_SIG_DILITHIUM: return "DAP_PKEY_TYPE_SIG_DILITHIUM";
        case DAP_PKEY_TYPE_SIG_FALCON: return "DAP_PKEY_TYPE_SIG_FALCON";
        ...
        case DAP_PKEY_TYPE_SIG_ML_DSA: return "DAP_PKEY_TYPE_SIG_ML_DSA";
...
DAP_STATIC_INLINE dap_sign_type_t dap_pkey_type_to_sign_type(dap_pkey_type_t a_pkey_type)
{
    ...
    switch (a_pkey_type.type){
        case DAP_PKEY_TYPE_SIG_BLISS: l_sign_type.type = SIG_TYPE_BLISS; break;
        case DAP_PKEY_TYPE_SIG_PICNIC: l_sign_type.type = SIG_TYPE_PICNIC; break;
        case DAP_PKEY_TYPE_SIG_TESLA: l_sign_type.type = SIG_TYPE_TESLA; break;
        case DAP_PKEY_TYPE_SIG_DILITHIUM : l_sign_type.type = SIG_TYPE_DILITHIUM; break;
        case DAP_PKEY_TYPE_SIG_FALCON : l_sign_type.type = SIG_TYPE_FALCON; break;
        ...
        case DAP_PKEY_TYPE_SIG_ML_DSA: l_sign_type.type = SIG_TYPE_ML_DSA; break;
...
DAP_STATIC_INLINE dap_pkey_type_t dap_pkey_type_from_sign_type(dap_sign_type_t a_sign_type)
{
    ...
    switch (a_sign_type.type){
        case SIG_TYPE_BLISS: l_pkey_type.type = DAP_PKEY_TYPE_SIG_BLISS; break;
        case SIG_TYPE_PICNIC: l_pkey_type.type = DAP_PKEY_TYPE_SIG_PICNIC; break;
        case SIG_TYPE_TESLA: l_pkey_type.type = DAP_PKEY_TYPE_SIG_TESLA; break;
        case SIG_TYPE_DILITHIUM: l_pkey_type.type = DAP_PKEY_TYPE_SIG_DILITHIUM; break;
        case SIG_TYPE_FALCON: l_pkey_type.type = DAP_PKEY_TYPE_SIG_FALCON; break;
        ...
        case SIG_TYPE_ML_DSA: l_pkey_type.type = DAP_PKEY_TYPE_SIG_ML_DSA; break;
...
{
    switch (a_pkey_type.type){
        case DAP_PKEY_TYPE_SIG_BLISS: return DAP_ENC_KEY_TYPE_SIG_BLISS;
        case DAP_PKEY_TYPE_SIG_PICNIC: return DAP_ENC_KEY_TYPE_SIG_PICNIC;
        case DAP_PKEY_TYPE_SIG_TESLA: return DAP_ENC_KEY_TYPE_SIG_TESLA;
        case DAP_PKEY_TYPE_SIG_DILITHIUM: return DAP_ENC_KEY_TYPE_SIG_DILITHIUM;
        case DAP_PKEY_TYPE_SIG_FALCON: return DAP_ENC_KEY_TYPE_SIG_FALCON;
        ...
        case DAP_PKEY_TYPE_SIG_ML_DSA: return DAP_ENC_KEY_TYPE_SIG_ML_DSA;
...
DAP_STATIC_INLINE dap_pkey_type_t dap_pkey_type_from_enc_key_type(dap_enc_key_type_t a_key_type)
{
    dap_pkey_type_t l_pkey_type={0};
    switch (a_key_type){
        case DAP_ENC_KEY_TYPE_SIG_BLISS: l_pkey_type.type = DAP_PKEY_TYPE_SIG_BLISS; break;
        case DAP_ENC_KEY_TYPE_SIG_PICNIC: l_pkey_type.type = DAP_PKEY_TYPE_SIG_PICNIC; break;
        case DAP_ENC_KEY_TYPE_SIG_TESLA: l_pkey_type.type = DAP_PKEY_TYPE_SIG_TESLA; break;
        case DAP_ENC_KEY_TYPE_SIG_DILITHIUM: l_pkey_type.type = DAP_PKEY_TYPE_SIG_DILITHIUM; break;
        case DAP_ENC_KEY_TYPE_SIG_FALCON: l_pkey_type.type = DAP_PKEY_TYPE_SIG_FALCON; break;
        ...
        case DAP_ENC_KEY_TYPE_SIG_ML_DSA: l_pkey_type.type = DAP_PKEY_TYPE_SIG_ML_DSA; break;

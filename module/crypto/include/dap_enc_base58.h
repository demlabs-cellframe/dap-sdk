...
DAP_INLINE char *dap_enc_base58_encode_hash_to_str(dap_hash_sha3_256_t *a_in_hash)
{
    return dap_enc_base58_encode_to_str(a_in_hash->raw, sizeof(dap_hash_sha3_256_t));
}

typedef union dap_enc_b58_hash_str {
    const char s[ DAP_ENC_BASE58_ENCODE_SIZE(sizeof(dap_hash_sha3_256_t)) ];

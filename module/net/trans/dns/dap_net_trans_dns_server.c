...
void dap_net_trans_dns_server_stop(dap_net_trans_dns_server_t *a_dns_server)
{
    ...
    dap_ht_foreach(a_dns_server->sessions, l_session, l_tmp) {
        dap_ht_del(a_dns_server->sessions, l_session);
                                   ...
                                   struct sockaddr_storage *a_addr, socklen_t a_addr_len)
{
    ...
    dap_ht_find(a_dns_server->sessions, a_addr, a_addr_len, l_session);
    ...
    dap_ht_add_keyptr(a_dns_server->sessions, &l_session->remote_addr, a_addr_len, l_session);

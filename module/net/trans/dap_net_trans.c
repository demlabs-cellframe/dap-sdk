                                    ...
                                    void *a_inheritor)
{
    ...
    dap_ht_find_int(s_trans_registry, a_type, l_existing);
    if (l_existing) {
    ...
    dap_ht_add(s_trans_registry, type, l_trans);
...
int dap_net_trans_unregister(dap_net_trans_type_t a_type)
{
    ...
    dap_ht_find_int(s_trans_registry, a_type, l_trans);
    ...
    dap_ht_del(s_trans_registry, l_trans);
...
dap_net_trans_t *dap_net_trans_find_by_name(const char *a_name)
{
    ...
    dap_ht_foreach(s_trans_registry, l_trans, l_tmp) {

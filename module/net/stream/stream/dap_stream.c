...
// Internal functions
static dap_stream_t * s_stream_new(dap_http_client_t * a_http_client, dap_cluster_node_addr_t *a_addr); // Create new stream
 ...
 */
dap_stream_t *s_stream_new(dap_http_client_t *a_http_client, dap_cluster_node_addr_t *a_addr)
{

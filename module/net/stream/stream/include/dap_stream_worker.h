...
typedef struct dap_stream_worker {
    dap_worker_t * worker;
    dap_context_queue_t *queue_ch_io; // IO queue for channels
    dap_context_queue_t *queue_ch_send; // send queue for channels
    dap_context_queue_t **queue_ch_io_input; // IO queue inputs for channels

...
/**
 * @brief HTTP method enumeration (6.0 compatibility)
 */
typedef enum dap_http_method {
    ...
    DAP_HTTP_METHOD_UNKNOWN
} dap_http_method_t;

/* Legacy aliases for compatibility */
#define HTTP_GET    DAP_HTTP_METHOD_GET
#define HTTP_HEAD   DAP_HTTP_METHOD_HEAD
#define HTTP_POST   DAP_HTTP_METHOD_POST
#define HTTP_PUT    DAP_HTTP_METHOD_PUT
#define HTTP_DELETE DAP_HTTP_METHOD_DELETE

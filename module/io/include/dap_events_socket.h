...
// DAP_TPS_TEST removed: Use larger size always for better performance
...
DAP_PRINTF_ATTR(3, 4) size_t dap_events_socket_write_f(dap_worker_t *a_worker, dap_events_socket_uuid_t a_es_uuid, const char *a_format, ...);
...
/* confcall W59-R7.3: NULL-guarded, matching every sibling accessor */
DAP_STATIC_INLINE size_t dap_events_socket_get_free_buf_size(dap_events_socket_t *a_es) { return a_es ? a_es->buf_out_size_max - a_es->buf_out_size : 0; }

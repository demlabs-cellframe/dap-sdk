...
3. После изменений **РЕГЕНЕРИРУЙ**: `./generate_simd.sh`
4. **КОММИТЬ** и `.tpl` файлы И сгенерированные файлы вместе
5. При добавлении архитектуры **ОБНОВИ** этот README

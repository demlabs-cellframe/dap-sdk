...
/**
 * @file dap_json_stage1_sse2.h
 * @brief SSE2-optimized Stage 1 JSON tokenization header
 * @details Entry point for SSE2 SIMD implementation (16 bytes/iteration)
 */
...
/**
 * @brief SSE2-optimized Stage 1 tokenization (16 bytes per iteration)

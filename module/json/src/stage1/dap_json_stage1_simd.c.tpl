...
{{#if USE_AVX512_MASK}}
#define COMPARISON_RESULT_TYPE   {{MOVEMASK_TYPE}}
{{else}}
...
{{#include "string_scanner_simd.tpl"}}
...
int dap_json_stage1_run_{{ARCH_LOWER}}(dap_json_stage1_t *a_stage1)
{
    ...
    while (pos < chunk_end) {
        ...
        while (chunk_pos < chunk_limit) {
            ...
            if (c == '"') {
                size_t end = s_scan_string_fast_{{ARCH_LOWER}}(a_stage1, chunk_pos);
    ...
    while (pos < input_len) {
        ...
        // String
            ...
            size_t end = s_scan_string_fast_{{ARCH_LOWER}}(a_stage1, pos);

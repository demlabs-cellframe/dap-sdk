...
macro(dap_create_final_library)
    ...
    if(TARGET dap_mlkem_512)
        list(APPEND DAP_LINK_LIBS dap_mlkem_512)
    endif()
    if(TARGET dap_mlkem_768)
        list(APPEND DAP_LINK_LIBS dap_mlkem_768)
    endif()
    if(TARGET dap_mlkem_1024)
        list(APPEND DAP_LINK_LIBS dap_mlkem_1024)
    endif()
    if(TARGET secp256k1)

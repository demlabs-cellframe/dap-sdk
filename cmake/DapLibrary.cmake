...
macro(dap_create_final_library)
    ...
    if(TARGET dap_crypto_kyber768)
        list(APPEND DAP_LINK_LIBS dap_crypto_kyber768)
    endif()
    if(TARGET dap_crypto_kyber1024)
        list(APPEND DAP_LINK_LIBS dap_crypto_kyber1024)
    endif()
    if(TARGET secp256k1)

...
if(EMSCRIPTEN)
    ...
    if(WASM_ENABLE_PTHREADS)
        ...
        set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -pthread -sPTHREAD_POOL_SIZE=4 -Wno-error=pthreads-mem-growth")
    endif()
...
if(UNIX)
    ...
    if (DAP_WASM)
        ...
        if(WASM_ENABLE_PTHREADS)
            set(_LOPT "${_LOPT} -sWASMFS -sOPFS")
            set(_LOPT "${_LOPT} -sINITIAL_MEMORY=67108864")
            set(_LOPT "${_LOPT} -sENVIRONMENT=web,worker")
            set(_LOPT "${_LOPT} -sPTHREAD_POOL_SIZE=navigator.hardwareConcurrency")
        else()
            set(_LOPT "${_LOPT} -sINITIAL_MEMORY=67108864")
            set(_LOPT "${_LOPT} -sENVIRONMENT=web")
        endif()
    endif()

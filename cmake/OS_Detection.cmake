...
# Sanitizers from the environment apply only to non-Release builds.
if(NOT DAP_RELEASE)
  ...
  if(DAP_MANAGE_CFLAGS)
    ...
    if (LINUX)
        ...
        if(DAP_DEBUG)
            ...
            set(_CCOPT "${CFLAGS_WARNINGS} -fno-ident -ffast-math -ftree-vectorize -fno-asynchronous-unwind-tables -ffunction-sections -std=gnu11")
            set(_LOPT "${_LOPT} -Wl,--gc-sections")
            if (DAP_ASAN)
    ...
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${_LOPT}")
...
if(WIN32)
  ...
  if(DAP_MANAGE_CFLAGS)
    ...
    if(DAP_DEBUG)
      ...
      set(_CCOPT "-static -std=gnu11 ${CFLAGS_WARNINGS} -O3 -fPIC -fno-ident -ffast-math -fno-strict-aliasing -ftree-vectorize -mfpmath=sse -mmmx -msse2 -fno-asynchronous-unwind-tables -ffunction-sections")
      set(_LOPT "${_LOPT} -Wl,--gc-sections")
      if(NOT DAP_DBG_INFO)

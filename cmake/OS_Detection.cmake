...
if(EMSCRIPTEN)
    ...
    option(DAP_WASM_PTHREADS "Enable pthreads in WASM build (requires COOP/COEP)" OFF)
    if(DAP_WASM_PTHREADS)
...
if(UNIX)
    ...
    if (DAP_WASM)
        ...
        set(_LOPT "-sALLOW_MEMORY_GROWTH=1 -sINITIAL_MEMORY=16777216 -sMAXIMUM_MEMORY=268435456")

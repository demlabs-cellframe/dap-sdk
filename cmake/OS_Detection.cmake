...
if(UNIX)
    ...
    if (APPLE)
        ...
        if (${_CMAKE_OSX_SYSROOT_PATH} MATCHES "iOS" OR ${_CMAKE_OSX_SYSROOT_PATH} MATCHES "iphoneos")
            set(IOS ON)
            add_definitions("-DDAP_OS_IOS")
        elseif (${_CMAKE_OSX_SYSROOT_PATH} MATCHES "MacOS" OR ${_CMAKE_OSX_SYSROOT_PATH} MATCHES "macosx")
            set(MACOS ON)

    ...
    if (LINUX)
        ...
        if(DAP_DEBUG)
            ...
            if (DEFINED ENV{DAP_ASAN})
                ...
                set(_CCOPT "${_CCOPT} -fsanitize=address -fsanitize-address-use-after-scope -fno-common -O1")
            ...
            elseif(DEFINED ENV{DAP_MSAN})
                if (CMAKE_C_COMPILER_ID MATCHES ".*[Cc][Ll][Aa][Nn][Gg].*")
                    ...
                    set(_CCOPT "${_CCOPT} -fsanitize=memory -fPIE -pie  -O2")
            ...
            elseif(DEFINED ENV{DAP_UBSAN})
                ...
                set(_CCOPT "${_CCOPT} -fsanitize=undefined -fsanitize=bounds ")
            ...
            if (DEFINED ENV{DAP_ASAN})
                message("[!] Address Sanitizer enabled")
                set(_CCOPT "${_CCOPT} -fsanitize=address -fsanitize-address-use-after-scope  -fno-common -O2")
                set(_LOPT "${_LOPT} -fsanitize=address")
            elseif(DEFINED ENV{DAP_MSAN})
                if (CMAKE_C_COMPILER_ID MATCHES ".*[Cc][Ll][Aa][Nn][Gg].*")
                    message("[!] Memory Sanitizer enabled")

...
if(UNIX)
    if (LINUX)
        ...
        elseif(DAP_DEBUG)
            ...
            set(_CCOPT "${CFLAGS_WARNINGS} -DNDEBUG -fno-ident ${DAP_FAST_MATH_FLAG} -ftree-vectorize -funroll-loops -fno-asynchronous-unwind-tables -ffunction-sections -fdata-sections -fno-plt -Wl,--gc-sections -std=gnu11")
            if (CMAKE_C_COMPILER_ID STREQUAL "GNU")
                set(_CCOPT "${_CCOPT} -fno-semantic-interposition")
            endif()
            if (DEFINED ENV{DAP_ASAN})
                message("[!] Address Sanitizer enabled (env)")
            ...
            elseif(DEFINED ENV{DAP_UBSAN})
                ...
                set(_CCOPT "${_CCOPT} -O3 -flto=auto")
                set(_LOPT "${_LOPT} -flto=auto -Wl,--gc-sections")
                if(NOT DAP_DBG_INFO)
    ...
    elseif (DARWIN)
        ...
        elseif(DAP_DEBUG)
          ...
          set(_CCOPT "${CCOPT_SYSTEM} ${CCFLAGS_COMMON} -DNDEBUG -O3 -flto=auto -fPIC -fno-strict-aliasing ${DAP_FAST_MATH_FLAG} -ftree-vectorize -funroll-loops -fno-asynchronous-unwind-tables -ffunction-sections -fdata-sections")
          set(_LOPT "${LDOPT_SYSTEM} -flto=auto -dead_strip")
          if (DEFINED ENV{DAP_ASAN})
            message("[!] Address Sanitizer enabled on Darwin (env)")
    ...
    elseif(BSD)
        ...
        if(DAP_DEBUG)
          ...
          set(_CCOPT "${CCOPT_SYSTEM} ${CFLAGS_WARNINGS} -DNDEBUG -O3 -flto=auto -fPIC -fno-strict-aliasing -fno-ident ${DAP_FAST_MATH_FLAG} -ftree-vectorize -funroll-loops -fno-asynchronous-unwind-tables -ffunction-sections -fdata-sections -std=gnu11")
          set(_LOPT "${LDOPT_SYSTEM} -flto=auto")
          SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS}")
        endif()
    endif()
    ...
    if (DAP_WASM)
        ...
        if(DAP_DEBUG)
            ...
            set(_CCOPT "${_CCOPT} -DNDEBUG -O3 -flto -funroll-loops")
        endif()
...
if(WIN32)
    ...
    if(DAP_DEBUG)
      ...
      set(_CCOPT "-static -std=gnu11 ${CFLAGS_WARNINGS} -O3 -flto=auto -fPIC -fno-ident ${DAP_FAST_MATH_FLAG} -fno-strict-aliasing -ftree-vectorize -funroll-loops -mfpmath=sse -mmmx -msse2 -fno-asynchronous-unwind-tables -ffunction-sections -fdata-sections -Wl,--gc-sections")
      if(NOT DAP_DBG_INFO)

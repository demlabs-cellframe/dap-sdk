...
function(create_final_shared_library)
    ...
    elseif(APPLE)
        # macOS: pthread and m are part of libSystem, no explicit -l flags needed
    ...
    foreach(MODULE ${${FINAL_LIB_MODULE_LIST_VAR}})
        if(TARGET ${MODULE})
            ...
            # Also collect from INTERFACE_LINK_LIBRARIES (for INTERFACE library dependencies)
            get_target_property(MODULE_DEPS ${MODULE} INTERFACE_LINK_LIBRARIES)
            if(MODULE_DEPS)
    ...
    if(BUILD_STATIC)
        ...
        elseif(APPLE)
            target_link_libraries(${STATIC_TARGET} PUBLIC

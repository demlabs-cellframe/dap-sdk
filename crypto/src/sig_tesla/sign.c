...
static void encode_sig(unsigned char *sm, unsigned char *c, poly *z, tesla_param_t *p)
{
    ...
    #define TZ(idx) ((uint32_t)t[(idx)])

    if(p->kind <= 1) {
        for (i = 0; i < (p->PARAM_N * p->PARAM_D/32); i += (p->PARAM_D)) {
            pt[i   ] = (TZ(j) & ((1<<21)-1)) | (TZ(j + 1) << 21);
            pt[i+ 1] = ((TZ(j + 1) >> 11) & ((1<<10)-1)) | ((TZ(j + 2) & ((1<<21)-1)) << 10) | (TZ(j + 3) << 31);
            pt[i+ 2] = ((TZ(j + 3) >>  1) & ((1<<20)-1)) | (TZ(j + 4) << 20);
            pt[i+ 3] = ((TZ(j + 4) >> 12) & ((1<<9)-1 )) | ((TZ(j + 5) & ((1<<21)-1)) <<  9) | (TZ(j + 6) << 30);
            pt[i+ 4] = ((TZ(j + 6) >>  2) & ((1<<19)-1)) | (TZ(j + 7) << 19);
            pt[i+ 5] = ((TZ(j + 7) >> 13) & ((1<<8)-1 )) | ((TZ(j + 8) & ((1<<21)-1)) <<  8) | (TZ(j + 9) << 29);
            pt[i+ 6] = ((TZ(j + 9) >>  3) & ((1<<18)-1)) | (TZ(j +10) << 18);
            pt[i+ 7] = ((TZ(j +10) >> 14) & ((1<<7)-1 )) | ((TZ(j +11) & ((1<<21)-1)) <<  7) | (TZ(j +12) << 28);
            pt[i+ 8] = ((TZ(j +12) >>  4) & ((1<<17)-1)) | (TZ(j +13) << 17);
            pt[i+ 9] = ((TZ(j +13) >> 15) & ((1<<6)-1 )) | ((TZ(j +14) & ((1<<21)-1)) <<  6) | (TZ(j +15) << 27);
            pt[i+10] = ((TZ(j +15) >>  5) & ((1<<16)-1)) | (TZ(j +16) << 16);
            pt[i+11] = ((TZ(j +16) >> 16) & ((1<<5)-1 )) | ((TZ(j +17) & ((1<<21)-1)) <<  5) | (TZ(j +18) << 26);
            pt[i+12] = ((TZ(j +18) >>  6) & ((1<<15)-1)) | (TZ(j +19) << 15);
            pt[i+13] = ((TZ(j +19) >> 17) & ((1<<4)-1 )) | ((TZ(j +20) & ((1<<21)-1)) <<  4) | (TZ(j +21) << 25);
            pt[i+14] = ((TZ(j +21) >>  7) & ((1<<14)-1)) | (TZ(j +22) << 14);
            pt[i+15] = ((TZ(j +22) >> 18) & ((1<<3)-1 )) | ((TZ(j +23) & ((1<<21)-1)) <<  3) | (TZ(j +24) << 24);
            pt[i+16] = ((TZ(j +24) >>  8) & ((1<<13)-1)) | (TZ(j +25) << 13);
            pt[i+17] = ((TZ(j +25) >> 19) & ((1<<2)-1 )) | ((TZ(j +26) & ((1<<21)-1)) <<  2) | (TZ(j +27) << 23);
            pt[i+18] = ((TZ(j +27) >>  9) & ((1<<12)-1)) | (TZ(j +28) << 12);
            pt[i+19] = ((TZ(j +28) >> 20) & ((1<<1)-1 )) | ((TZ(j +29) & ((1<<21)-1)) <<  1) | (TZ(j +30) << 22);
            pt[i+20] = ((TZ(j +30) >> 10) & ((1<<11)-1)) | (TZ(j +31) << 11);
            j += 32;
        }
    }
    if(p->kind == 2 || p->kind == 3) {
        for (i = 0; i < (p->PARAM_N * p->PARAM_D/32); i += (p->PARAM_D/2)) {
            pt[i   ] = (TZ(j) & ((1<<22)-1)) | (TZ(j + 1) << 22);
            pt[i+ 1] = ((TZ(j + 1) >> 10) & ((1<<12)-1)) | (TZ(j + 2) << 12);
            pt[i+ 2] = ((TZ(j + 2) >> 20) & ((1<< 2)-1)) | ((TZ(j + 3) & ((1<<22)-1)) << 2) | (TZ(j + 4) << 24);
            pt[i+ 3] = ((TZ(j + 4) >>  8) & ((1<<14)-1)) | (TZ(j + 5) << 14);
            pt[i+ 4] = ((TZ(j + 5) >> 18) & ((1<<4)-1 )) | ((TZ(j + 6) & ((1<<22)-1)) << 4) | (TZ(j + 7) << 26);
            pt[i+ 5] = ((TZ(j + 7) >>  6) & ((1<<16)-1)) | (TZ(j + 8) << 16);
            pt[i+ 6] = ((TZ(j + 8) >> 16) & ((1<<6)-1 )) | ((TZ(j + 9) & ((1<<22)-1)) << 6) | (TZ(j +10) << 28);
            pt[i+ 7] = ((TZ(j +10) >>  4) & ((1<<18)-1)) | (TZ(j +11) << 18);
            pt[i+ 8] = ((TZ(j +11) >> 14) & ((1<<8)-1 )) | ((TZ(j +12) & ((1<<22)-1)) << 8) | (TZ(j +13) << 30);
            pt[i+ 9] = ((TZ(j +13) >>  2) & ((1<<20)-1)) | (TZ(j +14) << 20);
            pt[i+10] = ((TZ(j +14) >> 12) & ((1<<10)-1)) | (TZ(j +15) << 10);
            j += 16;
        }
    }
    if(p->kind == 4) {
        for (i = 0; i < (p->PARAM_N * p->PARAM_D/32); i += (p->PARAM_D/8)) {
            pt[i  ] = (TZ(j) & ((1<<24)-1)) | (TZ(j + 1) << 24);
            pt[i+1] = ((TZ(j + 1) >>  8) & ((1<<16)-1)) | (TZ(j + 2) << 16);
            pt[i+2] = ((TZ(j + 2) >> 16) & ((1<< 8)-1)) | (TZ(j + 3) <<  8);
            j += 4;
        }
    }

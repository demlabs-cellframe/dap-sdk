...
extern void bliss_b_private_key_delete(void *private_key);
...
extern void bliss_b_public_key_delete(void *public_key);
...
extern void bliss_signature_delete(void *signature);

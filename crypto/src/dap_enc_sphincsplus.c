...
_Thread_local sphincsplus_config_t s_default_config = SPHINCSPLUS_SHA2_128F;
_Thread_local sphincsplus_difficulty_t s_default_difficulty = SPHINCSPLUS_SIMPLE;

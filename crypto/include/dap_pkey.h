...
enum dap_pkey_type_enum {
    ...
    DAP_PKEY_TYPE_MULTI_ECDSA_DILITHIUM = 0xfffd,
...
DAP_STATIC_INLINE const char *dap_pkey_type_to_str(dap_pkey_type_t a_type){
    switch (a_type.type) {
        ...
        case DAP_PKEY_TYPE_MULTI_ECDSA_DILITHIUM: return "DAP_PKEY_TYPE_MULTI_ECDSA_DILITHIUM";
...
DAP_STATIC_INLINE dap_sign_type_t dap_pkey_type_to_sign_type(dap_pkey_type_t a_pkey_type)
{
    ...
    switch (a_pkey_type.type){
        ...
        case DAP_PKEY_TYPE_MULTI_ECDSA_DILITHIUM: l_sign_type.type = SIG_TYPE_MULTI_ECDSA_DILITHIUM; break;
...
DAP_STATIC_INLINE dap_pkey_type_t dap_pkey_type_from_sign_type(dap_sign_type_t a_sign_type)
{
    ...
    switch (a_sign_type.type){
        ...
        case SIG_TYPE_MULTI_ECDSA_DILITHIUM: l_pkey_type.type = DAP_PKEY_TYPE_MULTI_ECDSA_DILITHIUM; break;
...
DAP_STATIC_INLINE dap_enc_key_type_t dap_pkey_type_to_enc_key_type(dap_pkey_type_t a_pkey_type)
{
    switch (a_pkey_type.type){
        ...
        case DAP_PKEY_TYPE_MULTI_ECDSA_DILITHIUM: return DAP_ENC_KEY_TYPE_SIG_MULTI_ECDSA_DILITHIUM;
        default:;
    }
...
DAP_STATIC_INLINE dap_pkey_type_t dap_pkey_type_from_enc_key_type(dap_enc_key_type_t a_key_type)
{
    ...
    switch (a_key_type){
        ...
        case DAP_ENC_KEY_TYPE_SIG_MULTI_ECDSA_DILITHIUM: l_pkey_type.type = DAP_PKEY_TYPE_MULTI_ECDSA_DILITHIUM; break;
        default: l_pkey_type.type = DAP_PKEY_TYPE_NULL; break;
    }
    return l_pkey_type;
}

...
bool py_dap_config_set_item_str(void* config, const char* section, const char* key, const char* value);
bool py_dap_config_set_item_int(void* config, const char* section, const char* key, int value);
bool py_dap_config_set_item_bool(void* config, const char* section, const char* key, bool value);

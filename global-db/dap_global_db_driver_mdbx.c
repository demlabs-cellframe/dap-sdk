...
size_t     l_upper_limit_of_db_size = 16;
    ...
    if ( MDBX_SUCCESS != (l_rc = mdbx_env_open(s_mdbx_env, s_db_path, MDBX_CREATE |  MDBX_COALESCE | MDBX_LIFORECLAIM | MDBX_WRITEMAP, 0664)) )
...
size_t  l_cnt = 0, l_count_out = 0;
    ...
    l_count_out = dap_min(l_count_out, DAP_GLOBAL_DB_MAX_OBJS);
...
MDBX_stat   l_stat;
    ...
    */
    do  {
        ...
        if ( !(  l_count_out = dap_min(l_stat.ms_entries, l_count_out)) ) {

...
// === Async functions ===
int dap_global_db_get(const char * a_group, const char *a_key,dap_global_db_callback_result_t a_callback,
...
int dap_global_db_get_last_raw(const char * a_group, dap_global_db_callback_result_raw_t a_callback,
                               dap_global_db_callback_arg_uid a_arg_uid);
int dap_global_db_get_all(const char * a_group, size_t l_results_page_size, dap_global_db_callback_results_t a_callback,
                          dap_global_db_callback_arg_uid a_arg_uid);
int dap_global_db_get_all_raw(const char * a_group, uint64_t a_first_id, size_t l_results_page_size, dap_global_db_callback_results_raw_t a_callback, dap_global_db_callback_arg_uid a_arg_uid);
...
int dap_global_db_pin(const char * a_group, const char *a_key, dap_global_db_callback_result_t a_callback, dap_global_db_callback_arg_uid a_args_uid);
...
byte_t *dap_global_db_get_unsafe(dap_global_db_context_t *a_global_db_context, const char *a_group,
                                 const char *a_key, size_t *a_data_size, bool *a_is_pinned, dap_nanotime_t *a_ts);
dap_store_obj_t *dap_global_db_get_raw_unsafe(dap_global_db_context_t *a_global_db_context, const char *a_group, const char *a_key);
...
byte_t *dap_global_db_get_last_unsafe(dap_global_db_context_t *a_global_db_context, const char *a_group, char **a_key, size_t *a_data_size,

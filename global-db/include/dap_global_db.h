...
int dap_global_db_get_all_raw(const char * a_group, dap_db_iter_t* a_iter, size_t l_results_page_size, dap_global_db_callback_results_raw_t a_callback, void * a_arg );

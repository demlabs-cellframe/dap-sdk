...
int dap_global_db_get_all(const char * a_group, size_t l_results_page_size, dap_nanotime_t a_timestamp, dap_global_db_callback_results_t a_callback, void * a_arg );

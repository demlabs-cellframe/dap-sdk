...
/**
 * @file dap_stream_trans_tls.h
 * @brief Direct TLS Trans Adapter for DAP Stream Protocol
 * 
 * This module implements a direct TLS 1.3 trans layer for DAP Stream,
 * providing encrypted communication without HTTP overhead. This trans
 ...
 * @see RFC 8446 - The Trans Layer Security (TLS) Protocol Version 1.3
 */
...
/**
 * @brief TLS trans private data
 */
typedef struct dap_stream_trans_tls_private {
    dap_stream_trans_tls_config_t config;  ///< Configuration
    dap_tls_state_t state;                     ///< Connection state
    
    // TLS ctx (OpenSSL SSL_CTX or WolfSSL WOLFSSL_CTX)
    void *tls_ctx;                             ///< TLS ctx
...
} dap_stream_trans_tls_private_t;
...
/**
 * @brief Register TLS Direct trans adapter
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_register(void);

/**
 * @brief Unregister TLS Direct trans adapter
 * @return 0 on success, negative error code on failure
 */
...
/**
 * @brief Get default TLS trans configuration
 * @return Default configuration structure
 */
dap_stream_trans_tls_config_t dap_stream_trans_tls_config_default(void);

/**
 * @brief Set TLS trans configuration
 * @param a_trans TLS trans instance
 * @param a_config Configuration structure
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_set_config(dap_stream_trans_t *a_trans,
                                         const dap_stream_trans_tls_config_t *a_config);

/**
 * @brief Get TLS trans configuration
 * @param a_trans TLS trans instance
 * @param a_config Output configuration structure
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_get_config(dap_stream_trans_t *a_trans,
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_load_cert(dap_stream_trans_t *a_trans,
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_load_ca(dap_stream_trans_t *a_trans,
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_pin_cert(dap_stream_trans_t *a_trans,
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_save_session(const dap_stream_t *a_stream,
                                           void **a_session_data,
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_restore_session(dap_stream_t *a_stream,
...
/**
 * @brief Check if stream is using TLS trans
 * @param a_stream Stream to check
 * @return true if TLS trans, false otherwise
 */
 ...
 */
dap_stream_trans_tls_private_t* dap_stream_trans_tls_get_private(dap_stream_t *a_stream);
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_get_info(const dap_stream_t *a_stream,
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_get_peer_cert(const dap_stream_t *a_stream,
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_stream_trans_tls_get_stats(const dap_stream_t *a_stream,

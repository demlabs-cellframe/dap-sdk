...
/**
 * @file dap_net_trans_dns_stream.h
 * @brief DNS Tunnel Trans Adapter for DAP Stream Protocol
 * 
 * This module implements a DNS-based tunneling trans layer for DAP Stream,
 * providing data transmission through DNS queries and responses. This trans
...
/**
 * @brief DNS tunnel trans configuration
 */
typedef struct dap_stream_trans_dns_config {
...
} dap_stream_trans_dns_private_t;
 ...
 * @param a_trans DNS trans instance
 ...
 * @return true if DNS tunnel trans, false otherwise
 */

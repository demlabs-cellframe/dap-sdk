 ...
 */
typedef struct dap_net_trans_websocket_server {
    ...
    dap_net_trans_t *trans;  ///< WebSocket trans instance
} dap_net_trans_websocket_server_t;

#define DAP_NET_TRANS_WEBSOCKET_SERVER(a) ((dap_net_trans_websocket_server_t *) (a)->_inheritor)
 ...
 * 
 * Allocates dap_net_trans_websocket_server_t structure. Call dap_net_trans_websocket_server_start()
 * to create internal dap_server_t and start listening.
 * 
 * @param a_server_name Server name for identification
 * @return Pointer to dap_net_trans_websocket_server_t instance or NULL on error
 */
 ...
 * 
 * Frees dap_net_trans_websocket_server_t structure. Call dap_net_trans_websocket_server_stop()

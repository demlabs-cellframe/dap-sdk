...
/**
 * @file dap_net_trans_websocket_stream.h
 * @brief WebSocket Trans Adapter for DAP Stream Protocol
 * 
 * This module implements a WebSocket-based trans layer for DAP Stream,
...
/**
 * @brief WebSocket trans configuration
 */
typedef struct dap_net_trans_websocket_config {
...
/**
 * @brief WebSocket trans private data
 */
typedef struct dap_net_trans_websocket_private {
    dap_net_trans_websocket_config_t config;  ///< Configuration
...
} dap_net_trans_websocket_private_t;
...
/**
 * @brief Get default WebSocket trans configuration
 * @return Default configuration structure
 */
dap_net_trans_websocket_config_t dap_net_trans_websocket_config_default(void);

/**
 * @brief Set WebSocket trans configuration
 * @param a_trans WebSocket trans instance
...
/**
 * @brief Get WebSocket trans configuration
 * @param a_trans WebSocket trans instance
 ...
 * @return true if WebSocket trans, false otherwise
 */
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_net_trans_websocket_send_close(dap_stream_t *a_stream, 
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_net_trans_websocket_send_ping(dap_stream_t *a_stream,
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_net_trans_websocket_send_pong(dap_stream_t *a_stream,
                                       const void *a_payload,
                                       size_t a_payload_size);
 ...
 * @return 0 on success, negative error code on failure
 */
int dap_net_trans_websocket_get_stats(const dap_stream_t *a_stream,

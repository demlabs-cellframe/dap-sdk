 ...
 * Range [850, 1350] = ~500 bytes variability for DPI resistance.
 * Increased from 1300 to 1350 to account for SALSA nonce (8 bytes).
 */
#define DAP_TRANSPORT_OBFUSCATION_MAX_SIZE 1350

 ...
 */
typedef struct dap_net_transport_http_server {
 ...
 * 
 * Allocates dap_net_transport_http_server_t structure. Call dap_net_transport_http_server_start()
 * to create internal dap_server_t and start listening.
 * 
 * @param a_server_name Server name for identification
 * @return Pointer to dap_net_transport_http_server_t instance or NULL on error
 */
 ...
 * 
 * Frees dap_net_transport_http_server_t structure. Call dap_net_transport_http_server_stop()

...
void test_http_redirect()
{
    ...
    printf("Testing HTTP redirect optimization...\n");
    
    // Test redirect within same host (should reuse connection)
    //log_it(L_NOTICE, "Test 1: Same host redirect");
    printf("Test 1: Same host redirect\n");
    dap_client_http_request_async(
        ...
        "GET",                  // method
        NULL,                   // content type
        "redirect-to?url=http://httpbin.org/get", // path that redirects to same host
        NULL,                   // request body
        0,                      // request size
        NULL,                   // cookie
        http_response_full_callback, // full callback
    ...
    // Test redirect to different host (should create new connection)
    //log_it(L_NOTICE, "Test 2: Different host redirect");
    printf("Test 2: Different host redirect\n");
    dap_client_http_request_async(
        NULL,                    // worker
        "httpbin.org",          // host
        80,                     // port
        "GET",                  // method
        NULL,                   // content type
        "redirect-to?url=http://example.com/", // path that redirects to different host
        NULL,                   // request body
        0,                      // request size
        NULL,                   // cookie
        http_response_full_callback, // full callback
    ...
    // Test relative redirect (should reuse connection)
    //log_it(L_NOTICE, "Test 3: Relative redirect");
    printf("Test 3: Relative redirect\n");
    dap_client_http_request_async(
        NULL,                    // worker
        "httpbin.org",          // host
        80,                     // port
        "GET",                  // method
        NULL,                   // content type
        "redirect-to?url=/get", // relative redirect
        NULL,                   // request body
        0,                      // request size
        NULL,                   // cookie
        http_response_full_callback, // full callback

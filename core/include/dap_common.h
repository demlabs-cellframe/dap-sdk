...
#define DAP_NULL_PTR DAP_CAST_PTR(void, NULL)
...
#define DAP_CALLOC(p, s)      ((size_t)(s) == 0 ? DAP_NULL_PTR : calloc((p), (s)))
#define DAP_ALMALLOC(p, s)    ((size_t)(s) == 0 ? DAP_NULL_PTR : _dap_aligned_alloc((p), (s)))
#define DAP_ALREALLOC(p, s)   ((size_t)(s) == 0 ? DAP_NULL_PTR : _dap_aligned_realloc((p), (s)))
...
#define DAP_NEW_SIZE(t, s)    ((size_t)(s) == 0 ? DAP_NULL_PTR : DAP_CAST_PTR(t, malloc(s)))
 /* Auto memory! Do not inline! */
#define DAP_NEW_STACK(t)            DAP_CAST_PTR(t, alloca(sizeof(t)))
#define DAP_NEW_STACK_SIZE(t, s)    ((size_t)(s) == 0 ? DAP_NULL_PTR : DAP_CAST_PTR(t, alloca(s)))
/* ... */
#define DAP_NEW_Z(t)          DAP_CAST_PTR(t, calloc(1, sizeof(t)))
#define DAP_NEW_Z_SIZE(t, s)  ((size_t)(s) != 0 ? DAP_CAST_PTR(t, calloc(1, (s))) : DAP_NULL_PTR)
#define DAP_REALLOC(s1, s2)   ((size_t)(s2) != 0 ? realloc((s1), (s2)) : ({ if (s1) free(s1); DAP_NULL_PTR; }))
#define DAP_DELETE(p)         free((void *)(p))
#define DAP_DUP(p)            ({ void *p1 = (uintptr_t)(p) != 0 ? malloc(sizeof(*(p))) : NULL; p1 ? memcpy(p1, (p), sizeof(*(p))) : DAP_NULL_PTR; })
#define DAP_DUP_SIZE(p, s)    ({ void *p1 = (p) && (size_t)(s) > 0 ? malloc(s) : NULL; p1 ? memcpy(p1, (p), (s)) : DAP_NULL_PTR; })
#endif
#define DAP_DEL_Z(a)          do { if (a) { DAP_DELETE(a); (a) = DAP_NULL_PTR; } } while (0);

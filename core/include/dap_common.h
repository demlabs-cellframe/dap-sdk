...
#define dap_is_signed(v) ( dap_minval(v) < 0 )
    ...
    ({                                                          \
        __typeof__(a) _a = (a); __typeof__(b) _b = (b);         \
        if (!( \
            (((double)_b > 0 && (double)_a > (double)dap_maxval(_a) - (double)_b) || \
            ((double)_b < 0 && (double)_a < (double)dap_minval(_a) - (double)_b)) \
        )) { (_a += _b); } \
        (_a); \
    })
    ...
    ({                                                  \
        ...
        if (!( \
            /*_a positive*/\
            ((double)_a > 0 && ( \
                ((double)_b > 0 && (double)_a > (double)((double)dap_maxval(_a) / (double)_b)) || \
                ((double)_b < 0 && ((double)_b < (double)((double)dap_minval(_a) / (double)_a))))\
            ) || \
            /*_a negative*/\
            (_a <= 0 && ( \
                ((double)_b > 0 && (double)_a < (double)((double)dap_minval(_a) / (double)_b)) || \
                (_a != 0 && (double)_b < 0 && (double)_b < (double)((double)dap_maxval(_a) / (double)_a))) \
            ) \
        )) { (_a *= _b); } \
        _a; \
    })

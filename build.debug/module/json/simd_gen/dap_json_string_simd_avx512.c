...
/**
 * @file dap_json_string_simd_avx512.c
 * @brief SIMD JSON String Scanner - AVX512 Implementation
 * 
 ...
 * 
 * Algorithm:
 * 1. Load 64 bytes into SIMD register
 ...
 * 
 * Performance: ~64 chars per cycle (vs 1 char/cycle reference)
 * Expected impact: +64x for string scanning
 * 
...
#include "dap_json_string_simd_avx512.h"

#define LOG_TAG "dap_json_string_avx512"

/**
 * @brief AVX512-optimized JSON string scanner
 * @details Processes 64 bytes at once using SIMD instructions
 * 
...
#include "arch/x86/string_scanner_avx512_impl.c"

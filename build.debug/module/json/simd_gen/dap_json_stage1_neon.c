...
// ============================================================================
#include "dap_json_stage1_neon_arch.h"
...
#define SIMD_SET1(val)           vdupq_n_u8((val))
...
static size_t s_scan_string_fast_neon(
...
)
{
    ...
    while (l_pos + chunk_size <= l_len) {
        ...
        MASK_TYPE quote_mask = (MASK_TYPE)dap_neon_movemask_u8(has_quote);
        MASK_TYPE backslash_mask = (MASK_TYPE)dap_neon_movemask_u8(has_backslash);
...
int dap_json_stage1_run_neon(dap_json_stage1_t *a_stage1)
{
    ...
    debug_if(dap_json_get_debug(), L_DEBUG, "Starting NEON SimdJSON Stage 1 tokenization (%zu bytes)", input_len);
    ...
    while (pos < chunk_end) {
        ...
        while (chunk_pos < chunk_limit) {
            ...
            if (c == '"') {
                size_t end = s_scan_string_fast_neon(a_stage1, chunk_pos);
    ...
    while (pos < input_len) {
        ...
        // String
            ...
            size_t end = s_scan_string_fast_neon(a_stage1, pos);
    ...
    debug_if(dap_json_get_debug(), L_DEBUG, "NEON SimdJSON Stage 1 complete: %zu tokens (%zu structural, %zu strings, %zu numbers, %zu literals)",

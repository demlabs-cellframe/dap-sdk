...
/**
 * @file dap_json_string_simd_avx2.c
 ...
 * Expected impact: +32x for string scanning
 * 
...
#include "dap_json_string_simd_avx2.h"

#define LOG_TAG "dap_json_string_avx2"

/**
 * @brief AVX2-optimized JSON string scanner
 * @details Processes 32 bytes at once using SIMD instructions
 * 

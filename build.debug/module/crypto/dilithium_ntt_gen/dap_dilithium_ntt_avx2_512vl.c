...
/**
 * @file dap_dilithium_ntt_avx2_512vl.c
 * @brief AVX2+AVX-512VL specialized NTT32 for Dilithium/ML-DSA
...
__attribute__((target("avx2,avx512f,avx512vl,avx512bw")))
void dap_dilithium_ntt_forward_avx2_512vl(int32_t a_coeffs[DIL_N])
{
...
__attribute__((target("avx2,avx512f,avx512vl,avx512bw")))
void dap_dilithium_ntt_inverse_avx2_512vl(int32_t a_coeffs[DIL_N])
{
...
__attribute__((target("avx2,avx512f,avx512vl,avx512bw")))
void dap_dilithium_pointwise_mont_avx2_512vl(

...
/**
 * @file dap_mlkem_poly_ops_neon.c
 * @brief NEON poly I/O operations for ML-KEM (compress, serialize, mulcache).
...
void dap_mlkem_poly_compress_d4_neon(uint8_t *a_r, const int16_t *a_coeffs)
{
...
void dap_mlkem_poly_compress_d5_neon(uint8_t *a_r, const int16_t *a_coeffs)
{
    const int16x8_t l_v = vdupq_n_s16(20159);
...
void dap_mlkem_poly_decompress_d4_neon(int16_t *a_r, const uint8_t *a_a)
{
...
void dap_mlkem_poly_decompress_d5_neon(int16_t *a_r, const uint8_t *a_a)
{
...
void dap_mlkem_poly_tobytes_neon(uint8_t *a_r, const int16_t *a_coeffs)
{
    for (unsigned i = 0; i < MLKEM_N / 8; i++) {
        int16x8_t f = vld1q_s16(a_coeffs + 8 * i);
...
void dap_mlkem_poly_frombytes_neon(int16_t *a_r, const uint8_t *a_a)
{
    for (unsigned i = 0; i < MLKEM_N / 8; i++) {
...
void dap_mlkem_poly_frommsg_neon(int16_t *a_r, const uint8_t *a_msg)
{
...
void dap_mlkem_poly_tomsg_neon(uint8_t *a_msg, const int16_t *a_coeffs)
{
...
void dap_mlkem_poly_mulcache_compute_neon(int16_t * restrict a_cache,

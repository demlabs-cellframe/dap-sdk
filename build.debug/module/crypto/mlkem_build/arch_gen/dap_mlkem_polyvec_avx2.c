...
/**
 * @file dap_mlkem_polyvec_avx2.c
 * @brief AVX2 polyvec compress/decompress + basemul_acc_cached for ML-KEM.
...
void dap_mlkem_polyvec_compress_d11_avx2(uint8_t *a_r, const int16_t *a_coeffs)
{
...
__attribute__((target("avx2")))
void dap_mlkem_polyvec_compress_d10_avx2(uint8_t *a_r, const int16_t *a_coeffs)
{
    const __m256i v = _mm256_set1_epi16(20159);
    const __m256i v8 = _mm256_slli_epi16(v, 3);
...
__attribute__((target("avx2")))
void dap_mlkem_polyvec_decompress_d11_avx2(int16_t *a_r, const uint8_t *a_a)
{
...
__attribute__((target("avx2")))
void dap_mlkem_polyvec_decompress_d10_avx2(int16_t *a_r, const uint8_t *a_a)
{
...
__attribute__((target("avx2")))
void dap_mlkem_polyvec_basemul_acc_cached_avx2(

 ...
 * @brief Transport Layer API Integration Test Suite
 ...
 * 
 * @note This is a lightweight integration test focusing on API functionality
 * @date 2025-11-01
...
#define LOG_TAG "test_transport_integration"
...
int main(void) {
    ...
    printf("\n");
    printf("═══════════════════════════════════════════════════════════════\n");
    printf("  Testing transport API and registration\n");
    printf("═══════════════════════════════════════════════════════════════\n");
    printf("\n");

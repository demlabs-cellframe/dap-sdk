...
DAP_MOCK(dap_worker_init);
DAP_MOCK(dap_worker_deinit);
DAP_MOCK(dap_context_init);
DAP_MOCK(dap_context_deinit);
DAP_MOCK(dap_context_new);
DAP_MOCK(dap_context_run);

// Mock wrappers are auto-generated by the mock framework - no need to write them manually

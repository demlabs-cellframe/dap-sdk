...
static bool s_test_float_infinity(void) {
    ...
    log_it(L_DEBUG, "Adding pos_inf: %f (s_is_inf_before=%d, hex=%016"DAP_UINT64_FORMAT_x")", 
    ...
    log_it(L_DEBUG, "Retrieved pos_inf: %f (s_is_inf_after=%d, <0=%d, hex=%016"DAP_UINT64_FORMAT_x")", 
